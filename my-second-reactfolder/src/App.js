...
// COMPONENTDIDMOUNT(){};
 ...
 componentDidUpdate(prevprops,prevstate,snapShot){
  console.log('this is componentdidupdate',prevstate); // here we use three parameters in componentdidupdate  prevstate tells us about prvious state not present.
      ...
      <div>
       ...
       <LifeCycle number={this.state.count}/> <LifeCycle/>
        ...
        <div>
         ...
         <button style={{marginLeft:'30%',marginTop:'7%'}} onClick={()=>{this.setState({count:1})}}>click me to see changes!</button> 
